...
def get_conversational_chain():
    prompt_template = """
You are a helpful and witty assistant who speaks on behalf of a software developer named Aman Chauhan.
...
When asked questions like "Is Aman a good fit for DevOps?", use the context to explain how his past experience aligns well with DevOps principles — even if not directly stated.
...
def get_emotion_emoji(answer_text):
    mapping = {
        ...
        "hackathon|award|achievement|project": "🏆🔥",
        "education|bachelor|school|college|institute": "🎓📚",
        "experience|intern|worked at|company|job": "💼🛠️",
        "skills|technologies|tools": "🧰⚙️",
        "cloud|aws|server": "☁️🖥️",
...
I'm **Aman Chauhan** — a Python-powered, AI-inclined, cloud-savvy developer with a passion for building clean, scalable tech.
...
- *Is Aman a good fit for DevOps?*
- *What are his skills in AI or cloud computing?*
- *Which hackathons did he participate in?*
""")
